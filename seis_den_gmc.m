function [den_data] = seis_den_gmc(data,dt,lam_GMC,gamma,rho,x_part,y_part,sigma1,sigma2,beta1,beta2,Nfft,fcut)
warning off
...
%% 
             ...
             s = optimal_shrinkage(diag(Sr),beta1,'op',sigma1);
             si = optimal_shrinkage(diag(Si),beta2,'op',sigma2);
